...
public abstract class OddServiceTest {
    protected OddService oddService;
    protected OddRepository oddRepository;
    ...
    void testGetOddsForFixtureAndOddGroupDatabaseError() {
        ...
        when(oddRepository.findByFixtureStateAndFixtureIdAndOddGroupId(Constants.FIXTURE_NOT_STARTED, null, null))
    ...
    void testExistsWithFixtureIdAndOddGroupIdNullError() {
        ...
        when(oddRepository.existsByFixtureIdAndOddGroupId(null, null))
                .thenThrow(new NullPointerException());

...
public class SecretKeys {
    ...
    public static Algorithm getAlgorithm() {
        ...
        String property = secretFile.getProperty(jwt_secret_key_field);
        if(property==null){
            logger.error("Exception: Error loading property for Algorithm!");
            return null;
        }
        return Algorithm.HMAC256(property.getBytes());
    }
}
